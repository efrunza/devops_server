...
{    
    ...
    public async getProvincesStates(): Promise<any>{
    ...
    public async getLanguageCodes(): Promise<any>{

        let newLanguageCodeList = '{ "QasData": [{"code":"EN", "name":"English", "desc":""}]}';
        return newLanguageCodeList;
    }

    public async getApplicantBioData(): Promise<any>{
    ...
    public async getAvailablePrograms(req:any): Promise<any>
    {
    ...
    public async getApplicationInfoAgent(): Promise<any>{
    ...
    public async storeApplicantBioData(req:any): Promise<any>{
    ...
    private getAvailableProgramsParameters(req: any):any
    {
    ...
    private getStoreApplicantBioDataParameters(req:any)
    {
      let inputParameters = [
    ...
    private normalize(object) 
    {
        Object.keys(object).forEach(key => {
          if (object[key]) {
            if (
              key != 'isPreviousStudent' &&
              key != 'dob' &&
      ...
      private charFlagToBoolean(charFlag) 
      {
        if (charFlag) {
